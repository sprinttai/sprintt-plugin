...
12. Revision rounds per deliverable (default: 2 — confirm with user before accepting)
13. Deemed acceptance window — how many business days before a non-response is treated as acceptance (default: 5 — confirm with user; explain this is a key protection)

**Timeline:**
14. Project start date
15. Key milestones and target dates
16. Total estimated duration (weeks)

**Commercial:**
17. Service type (refer to `services/offerings.md` for categories)
18. Is this a Design Partner engagement? If yes, what is the discount percentage?
19. Will any SDLC contractors be involved in delivery? If yes:
    - Estimated contractor hours and rate
    - Use the contractor pricing formula from `services/pricing.md` to calculate the project price floor before applying value-based pricing
20. Fee structure — line items with amounts, or ask user to describe the scope and suggest pricing based on `services/pricing.md`
21. Payment schedule (derive from `services/pricing.md` rules based on total project fee)
22. Client point of contact name for Section 5
