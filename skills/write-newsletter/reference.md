...
- No publishing platform is currently selected. Output is plain text ready to paste into any platform.
- Once a platform is chosen, update this skill to include platform-specific formatting guidance.
- Newsletter CTA default is the strategy call booking link — pull from `company/entity.md` if a direct link is needed.
